...
import { Video, ArrowLeft, Calendar, Clock, Users, Link2, Copy, CheckCircle2 } from "lucide-react";
...
const CreateMeeting = () => {
  ...
  const handleCreateMeeting = () => {
    ...
    const generatedLink = `https://videoconf.ru/meet/${Math.random().toString(36).substring(7)}`;
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-12 max-w-2xl">
          <Card className="p-8 text-center">
            ...
            <h2 className="text-2xl font-bold mb-2">Встреча успешно создана!</h2>
            <p className="text-muted-foreground mb-8">
              Приглашения отправлены всем участникам на email
            </p>
            
            <div className="bg-secondary/50 rounded-lg p-4 mb-6">
              <Label className="text-sm font-medium mb-2 block">Ссылка для участников</Label>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Button size="lg" variant="gradient" onClick={() => navigate("/meeting/demo")}>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch 
                  ...
                  onCheckedChange={(checked) => setSettings({...settings, recording: checked})}
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch 
                  ...
                  onCheckedChange={(checked) => setSettings({...settings, requireESIA: checked})}
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch 
                  ...
                  onCheckedChange={(checked) => setSettings({...settings, sharedEditor: checked})}
                />
              </div>
            </div>
          </Card>
