...
import { Video, Shield, Users, TrendingUp, FileText, Lock, Zap, CheckCircle2 } from "lucide-react";
...
const Landing = () => {
  ...
  const features = [
    {
      ...
      description: "Качественная связь до 100+ участников с минимальной задержкой"
    },
    {
  ...
  const useCases = [
    {
      title: "Образование",
      description: "Онлайн-уроки, лекции, родительские собрания с автоматической записью",
      stats: "10,000+ школ"
    },
    {
      title: "Государственные органы",
      description: "Совещания, брифинги, межведомственные встречи с полной конфиденциальностью",
    ...
    },
    {
      ...
      description: "Деловые встречи, тренинги, вебинары для команд любого размера",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <header className="border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Button size="sm" variant="gradient" onClick={() => navigate("/auth")}>
              Начать работу
            </Button>
          </nav>
        </div>
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Российское решение для государственного сектора, образования и бизнеса. 
              Интеграция с ЕСИА, AI-транскрипция, полный контроль данных.
            </p>
      ...
      <section id="features" className="py-24 bg-secondary/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Все необходимое для эффективной работы</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, i) => (
              <Card key={i} className="p-6 hover:shadow-card transition-shadow bg-card border-border">
      ...
      <section id="cases" className="py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Проверено тысячами организаций</h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              От школ до министерств — наше решение работает в самых требовательных условиях
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <Card 
                key={i} 
                className={`p-8 relative ${plan.popular ? 'border-primary shadow-card' : 'border-border'} bg-card`}
              >
                {plan.popular && (
